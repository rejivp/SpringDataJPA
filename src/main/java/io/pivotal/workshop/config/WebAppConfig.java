...
@ComponentScan("io.pivotal.workshop")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("io.pivotal.workshop.dao")
public class WebAppConfig {
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "entitymanager.packagesToScan";
